...
import 'package:musicplayer/model/lyric.dart';
...
StreamSubscription? streamSubscription;
 @override
  ...
  void initState() {
    ...
    get(Uri.parse('https://paxsenixofc.my.id/server/getLyricsMusix.php?q=${widget.music.songName} ${widget.music.artistName}&type=default'))
    .then((response){
      ...
      .map((e) => Lyric(e.split(' ').
      sublist(1).join(' '),
      DateFormat("[mm:ss.S]").parse(e.split(' ')[0])))
      .toList();
      setState(() {});
    });
    super.initState();
